...
const Home = () => {
	return (
		<div className="text-center w-75 mx-auto">
			...
			<Card title="The Lambo" feet="Click me" body="Cool cars are the ones that really grab you, there's something special about them special cars." img="https://www.ilusso.com/wp-content/uploads/3-3-1024x683.jpg"/>
